...
public:
	...
	std::map<uint8_t, Instruction> op_map{
		...
		{0x61, Instruction("ADC_IIDRX", &CPU6502::ADC, &CPU6502::mod_iidrx, 6)},																													{0x41, Instruction("EOR_IIDRX", &CPU6502::EOR, &CPU6502::mod_iidrx, 6)},						{0xA0, Instruction("LDY_IMD", &CPU6502::LDY, &CPU6502::mod_imd, 2)},							{0x6A, Instruction("ROR_ACC", &CPU6502::ROR, &CPU6502::mod_acc, 2)},							{0x8C, Instruction("STY_ABS", &CPU6502::STY, &CPU6502::mod_abs, 4)},
