...
class CPU6502
{
	...
	enum AdditionalCycles {
		...
		NewPage // +1 if branch succedes, +2 if to a new page
	};
	...
	struct Instruction {
		...
		Instruction(std::string op_name, op_ptr operation,
				    adrmod_ptr adr_mod, uint8_t cycles, AdditionalCycles additional_cycle) : 
	...
	public:
		...
		std::map<uint8_t, Instruction> op_map{
			...
			{0x69, Instruction("ADC_IMD", &CPU6502::ADC, &CPU6502::mod_imd, 2)},						{0x18, Instruction("CLC_IMP", &CPU6502::CLC, &CPU6502::mod_imp, 2)},							{0x49, Instruction("EOR_IMD", &CPU6502::EOR, &CPU6502::mod_imd, 2)},							{0xA2, Instruction("LDX_IMD", &CPU6502::LDX, &CPU6502::mod_imd, 2)},							{0x2A, Instruction("ROL_ACC", &CPU6502::ROL, nullptr, 2)},										{0x86, Instruction("STX_ZP", &CPU6502::STX, &CPU6502::mod_zp, 3)},
			...
			{0x61, Instruction("ADC_IIDRX", &CPU6502::ADC, &CPU6502::mod_iidrx, 6)},																													{0x41, Instruction("EOR_IIDRX", &CPU6502::EOR, &CPU6502::mod_iidrx, 6)},						{0xA0, Instruction("LDY_IMD", &CPU6502::LDY, &CPU6502::mod_imd, 2)},							{0x6A, Instruction("ROR_ACC", &CPU6502::ROR, nullptr, 2)},										{0x8C, Instruction("STY_ABS", &CPU6502::STY, &CPU6502::mod_abs, 4)},
			{0x71, Instruction("ADC_IDRIY", &CPU6502::ADC, &CPU6502::mod_idriy, 5, PageCrossed)},																										{0x51, Instruction("EOR_IDRIY", &CPU6502::EOR, &CPU6502::mod_idriy, 5, PageCrossed)},			{0xA4, Instruction("LDY_ZP", &CPU6502::LDY, &CPU6502::mod_zp, 3)},								{0x66, Instruction("ROR_ZP", &CPU6502::ROR, &CPU6502::mod_zp, 5)},
			...
			{0x2D, Instruction("AND_ABS", &CPU6502::AND, &CPU6502::mod_abs, 4)},						{0xCD, Instruction("CMP_ABS", &CPU6502::CMP, &CPU6502::mod_abs, 4)},							{0xFE, Instruction("INC_ABSX", &CPU6502::INC, &CPU6502::mod_absx, 7)},							{0x4A, Instruction("LSR_ACC", &CPU6502::LSR, nullptr, 2)},										{0x40, Instruction("RTI_IMP", &CPU6502::RTI, &CPU6502::mod_imp, 6)},							{0x9A, Instruction("TXS_IMP", &CPU6502::TXS, &CPU6502::mod_imp, 2)},
			...
			{0x21, Instruction("AND_IIDRX", &CPU6502::AND, &CPU6502::mod_iidrx, 6)},					{0xC1, Instruction("CMP_IIDRX", &CPU6502::CMP, &CPU6502::mod_iidrx, 6)},						{0xC8, Instruction("INY_IMP", &CPU6502::INY, &CPU6502::mod_imp, 2)},							{0x4E, Instruction("LSR_ABS", &CPU6502::LSR, &CPU6502::mod_abs, 6)},							{0xE9, Instruction("SBC_IMD", &CPU6502::SBC, &CPU6502::mod_imd, 2)},
			{0x31, Instruction("AND_IDRIY", &CPU6502::AND, &CPU6502::mod_iidrx, 5, PageCrossed)},		{0xD1, Instruction("CMP_IDRIY", &CPU6502::CMP, &CPU6502::mod_idriy, 5, PageCrossed)},																											{0x5E, Instruction("LSR_ABSX", &CPU6502::LSR, &CPU6502::mod_absx, 7)},							{0xE5, Instruction("SBC_ZP", &CPU6502::SBC, &CPU6502::mod_zp, 3)},
																																																																																																		{0xF5, Instruction("SBC_ZPX", &CPU6502::SBC, &CPU6502::mod_zpx, 4)},
			{0x0A, Instruction("ASL_ACC", &CPU6502::ASL, nullptr, 2)},									{0xE0, Instruction("CPX_IMD", &CPU6502::CPX, &CPU6502::mod_imd, 2)},							{0x4C, Instruction("JMP_ABS", &CPU6502::JMP, &CPU6502::mod_abs, 3)},							{0xEA, Instruction("NOP_IMP", &CPU6502::NOP, &CPU6502::mod_imp, 2)},							{0xED, Instruction("SBC_ABS", &CPU6502::SBC, &CPU6502::mod_abs, 4)},
			...
			{0x0E, Instruction("ASL_ABS", &CPU6502::ASL, &CPU6502::mod_abs, 6)},																																																						{0x05, Instruction("ORA_ZP", &CPU6502::ORA, &CPU6502::mod_zp, 3)},								{0xE1, Instruction("SBC_IIDRX", &CPU6502::SBC, &CPU6502::mod_iidrx, 6)},
			{0x1E, Instruction("ASL_ABSX", &CPU6502::ASL, &CPU6502::mod_absx, 7)},																																																						{0x15, Instruction("ORA_ZPX", &CPU6502::ORA, &CPU6502::mod_zpx, 4)},							{0xF1, Instruction("SBC_IDRIY", &CPU6502::SBC, &CPU6502::mod_idriy, 5, PageCrossed)},
			...
			{0xF0, Instruction("BEQ_REL", &CPU6502::BEQ, &CPU6502::mod_rel, 2, NewPage)},				{0xCC, Instruction("CPY_ABS", &CPU6502::CPY, &CPU6502::mod_abs, 4)},							{0xB5, Instruction("LDA_ZPX", &CPU6502::LDA, &CPU6502::mod_zpx, 4)},							{0x01, Instruction("ORA_IIDRX", &CPU6502::ORA, &CPU6502::mod_iidrx, 6)},						{0x78, Instruction("SEI_IMP", &CPU6502::SEI, &CPU6502::mod_imp, 2)},
			{0x30, Instruction("BMI_REL", &CPU6502::BMI, &CPU6502::mod_rel, 2, NewPage)},																												{0xAD, Instruction("LDA_ABS", &CPU6502::LDA, &CPU6502::mod_abs, 4)},							{0x11, Instruction("ORA_IDRIY", &CPU6502::ORA, &CPU6502::mod_idriy, 5, PageCrossed)},
			...
			{0x50, Instruction("BVC_REL", &CPU6502::BVC, &CPU6502::mod_rel, 2, NewPage)},				{0xCE, Instruction("DEC_ABS", &CPU6502::DEC, &CPU6502::mod_abs, 6)},							{0xA1, Instruction("LDA_IIDRX", &CPU6502::LDA, &CPU6502::mod_iidrx, 6)},						{0x08, Instruction("PHP_IMP", &CPU6502::PHP, &CPU6502::mod_imp, 3)},							{0x8D, Instruction("STA_ABS", &CPU6502::STA, &CPU6502::mod_abs, 4)},
			{0x70, Instruction("BVS_REL", &CPU6502::BVS, &CPU6502::mod_rel, 2, NewPage)},				{0xDE, Instruction("DEC_ABSX", &CPU6502::DEC, &CPU6502::mod_absx, 7)},							{0xB1, Instruction("LDA_IDRIY", &CPU6502::LDA, &CPU6502::mod_idriy, 5, PageCrossed)},			{0x68, Instruction("PLA_IMP", &CPU6502::PLA, &CPU6502::mod_imp, 4)},							{0x9D, Instruction("STA_ABSX", &CPU6502::STA, &CPU6502::mod_absx, 5)},
																																																																										{0x28, Instruction("PLP_IMP", &CPU6502::PLP, &CPU6502::mod_imp, 4)},							{0x99, Instruction("STA_ABSY", &CPU6502::STA, &CPU6502::mod_absy, 5)},
			{0x24, Instruction("BIT_ZP", &CPU6502::BIT, &CPU6502::mod_zp, 3)},							{0xCA, Instruction("DEX_IMP", &CPU6502::DEX, &CPU6502::mod_imp, 2)},																																																							{0x81, Instruction("STA_IIDRX", &CPU6502::STA, &CPU6502::mod_iidrx, 6)},
			{0x2C, Instruction("BIT_ABS", &CPU6502::BIT, &CPU6502::mod_abs, 4)},						{0x88, Instruction("DEY_IMP", &CPU6502::DEY, &CPU6502::mod_imp, 2)},																																																							{0x91, Instruction("STA_IDRIY", &CPU6502::STA, &CPU6502::mod_idriy, 6)},
