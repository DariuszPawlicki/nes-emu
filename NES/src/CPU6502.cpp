...
{ 
	...
	this->instr_opcode = this->bus.read(this->pc); 
	...
	this->acc_memory_switch = false; // If addressing mode is ACC then it will be changed to true,
									//  else it prevents entering to conditional blocks of certain instructions
								   //   which expects this value to be true e.g. ASL
