...
public:
	...
	std::unordered_map<uint8_t, Instruction> op_map{
		...
		{0x61, Instruction("ADC_IDRX", &CPU6502::ADC, &CPU6502::mod_idrx, 6)},																														{0x41, Instruction("EOR_IDRX", &CPU6502::EOR, &CPU6502::mod_idrx, 6)},							{0xA0, Instruction("LDY_IMD", &CPU6502::LDY, &CPU6502::mod_imd, 2)},							{0x6A, Instruction("ROR_ACC", &CPU6502::ROR, &CPU6502::mod_acc, 2)},							{0x8C, Instruction("STY_ABS", &CPU6502::STY, &CPU6502::mod_abs, 4)},
		...
		{0x21, Instruction("AND_IDRX", &CPU6502::AND, &CPU6502::mod_idrx, 6)},						{0xC1, Instruction("CMP_IDRX", &CPU6502::CMP, &CPU6502::mod_idrx, 6)},							{0xC8, Instruction("INY_IMP", &CPU6502::INY, &CPU6502::mod_imp, 2)},							{0x4E, Instruction("LSR_ABS", &CPU6502::LSR, &CPU6502::mod_abs, 6)},							{0xE9, Instruction("SBC_IMD", &CPU6502::SBC, &CPU6502::mod_imd, 2)},
		{0x31, Instruction("AND_IDRY", &CPU6502::AND, &CPU6502::mod_idrx, 5, PageCrossed)},			{0xD1, Instruction("CMP_IDRY", &CPU6502::CMP, &CPU6502::mod_idry, 5, PageCrossed)},																												{0x5E, Instruction("LSR_ABSX", &CPU6502::LSR, &CPU6502::mod_absx, 7)},							{0xE5, Instruction("SBC_ZP", &CPU6502::SBC, &CPU6502::mod_zp, 3)},
		...
		{0xF0, Instruction("BEQ_REL", &CPU6502::BEQ, &CPU6502::mod_rel, 2, NewPage)},				{0xCC, Instruction("CPY_ABS", &CPU6502::CPY, &CPU6502::mod_abs, 4)},							{0xB5, Instruction("LDA_ZPX", &CPU6502::LDA, &CPU6502::mod_zpx, 4)},							{0x01, Instruction("ORA_IDRX", &CPU6502::ORA, &CPU6502::mod_idrx, 6)},							{0x78, Instruction("SEI_IMP", &CPU6502::SEI, &CPU6502::mod_imp, 2)},
		...
		{0x50, Instruction("BVC_REL", &CPU6502::BVC, &CPU6502::mod_rel, 2, NewPage)},				{0xCE, Instruction("DEC_ABS", &CPU6502::DEC, &CPU6502::mod_abs, 6)},							{0xA1, Instruction("LDA_IDRX", &CPU6502::LDA, &CPU6502::mod_idrx, 6)},							{0x08, Instruction("PHP_IMP", &CPU6502::PHP, &CPU6502::mod_imp, 3)},							{0x8D, Instruction("STA_ABS", &CPU6502::STA, &CPU6502::mod_abs, 4)},
		{0x70, Instruction("BVS_REL", &CPU6502::BVS, &CPU6502::mod_rel, 2, NewPage)},				{0xDE, Instruction("DEC_ABSX", &CPU6502::DEC, &CPU6502::mod_absx, 7)},							{0xB1, Instruction("LDA_IDRY", &CPU6502::LDA, &CPU6502::mod_idry, 5, PageCrossed)},				{0x68, Instruction("PLA_IMP", &CPU6502::PLA, &CPU6502::mod_imp, 4)},							{0x9D, Instruction("STA_ABSX", &CPU6502::STA, &CPU6502::mod_absx, 5)},
																																																																									{0x28, Instruction("PLP_IMP", &CPU6502::PLP, &CPU6502::mod_imp, 4)},							{0x99, Instruction("STA_ABSY", &CPU6502::STA, &CPU6502::mod_absy, 5)},
		{0x24, Instruction("BIT_ZP", &CPU6502::BIT, &CPU6502::mod_zp, 3)},							{0xCA, Instruction("DEX_IMP", &CPU6502::DEX, &CPU6502::mod_imp, 2)},																																																							{0x81, Instruction("STA_IDRX", &CPU6502::STA, &CPU6502::mod_idrx, 6)},
		{0x2C, Instruction("BIT_ABS", &CPU6502::BIT, &CPU6502::mod_abs, 4)},						{0x88, Instruction("DEY_IMP", &CPU6502::DEY, &CPU6502::mod_imp, 2)},																																																							{0x91, Instruction("STA_IDRY", &CPU6502::STA, &CPU6502::mod_idry, 6)},
