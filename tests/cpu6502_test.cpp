...
TEST_F(CPU6502Test, Adc) {
	...
	processor->status = 0b00000001;

	processor->ADC();

	ASSERT_EQ(processor->acc, 0xA1);
	ASSERT_EQ(processor->status, 0b11000000);
	...
	ASSERT_EQ(processor->status, 0b00000001);
}
...
TEST_F(CPU6502Test, And) {
	...
	ASSERT_EQ(processor->status, 0b00000000);

	processor->acc = 0b00;
	processor->AND();

	ASSERT_EQ(processor->acc, 0b00000000);
	ASSERT_EQ(processor->status, 0b00000010);

	processor->acc = 0b10000000;
	processor->AND();

	ASSERT_EQ(processor->acc, 0b10000000);
	ASSERT_EQ(processor->status, 0b10000000);
}
...
TEST_F(CPU6502Test, AslOnMemory) {
	...
	ASSERT_EQ(processor->status, 0b00000011);
}
...
TEST_F(CPU6502Test, Bit) {
	...
	ASSERT_EQ(processor->status, 0b11000010);
}
...
TEST_F(CPU6502Test, Clc) {
	...
	ASSERT_EQ(processor->status, 0);
}


TEST_F(CPU6502Test, Cld) {

	processor->status = 0b00001000;
	processor->CLD();
...
TEST_F(CPU6502Test, Plp) {
	...
	ASSERT_EQ(processor->status, 0b10101010);
}
...
TEST_F(CPU6502Test, Rti) {
	...
	ASSERT_EQ(processor->status, 0b10000001);
...
TEST_F(CPU6502Test, Sbc) {
	...
	ASSERT_EQ(processor->status, 0b11000001);
...
TEST_F(CPU6502Test, Sed) {
	...
	ASSERT_EQ(processor->status, 0b00001000);
}
...
TEST_F(CPU6502Test, Sei) {
	...
	ASSERT_EQ(processor->status, 0b00000100);
}
